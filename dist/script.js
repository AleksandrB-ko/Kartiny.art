...
/* harmony import */ var _modules_russianLangInputs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/russianLangInputs */ "./src/js/modules/russianLangInputs.js");
/* harmony import */ var _modules_showHiddenStyles__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/showHiddenStyles */ "./src/js/modules/showHiddenStyles.js");
/* harmony import */ var _modules_showServerCards__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/showServerCards */ "./src/js/modules/showServerCards.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_russianLangInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="name"]');
  Object(_modules_russianLangInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="message"]');
  Object(_modules_showHiddenStyles__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-styles', '.styles-2');
  Object(_modules_showServerCards__WEBPACK_IMPORTED_MODULE_6__["default"])('.button-styles', '#styles .row');
  ...
  Object(_modules_pictureSize__WEBPACK_IMPORTED_MODULE_9__["default"])('.sizes-block'); // accordion('.accordion-heading', '.accordion-block');
...
/* harmony default export */ __webpack_exports__["default"] = (calc); // когда данные берем из БД
...
var drop = function drop() {
  var fileInput = document.querySelectorAll('[name="upload"]');
  ...
  fileInput.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      var dots;
      var nameSplitArray = input.files[0].name.split('.');
      nameSplitArray[0].length > 5 ? dots = "..." : dots = '.';
      var uploadFileName = nameSplitArray[0].substring(0, 6) + dots + nameSplitArray[1];
...
var forms = function forms() {
  ...
  upload.forEach(function (item) {
    item.addEventListener('input', function () {
      ...
      var dots;
      var nameSplitArray = item.files[0].name.split('.');
      nameSplitArray[0].length > 5 ? dots = "..." : dots = '.';
      var uploadFileName = nameSplitArray[0].substring(0, 6) + dots + nameSplitArray[1];
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    var giftDestroy = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  ...
  scrollOpensGiftModaL('.fixed-gift'); // showModalByTime('.popup-consultation', 5000);
};
...
/***/ "./src/js/modules/russianLangInputs.js":
/*!*********************************************!*\
  !*** ./src/js/modules/russianLangInputs.js ***!
  \*********************************************/
/*! exports provided: default */
...
var russianLangInputs = function russianLangInputs(selector) {
...
/* harmony default export */ __webpack_exports__["default"] = (russianLangInputs);
...
/***/ "./src/js/modules/showHiddenStyles.js":
/*!********************************************!*\
  !*** ./src/js/modules/showHiddenStyles.js ***!
  \********************************************/
/*! exports provided: default */
...
var showHiddenStyles = function showHiddenStyles(trigger, cardsWithStyles) {
  var cards = document.querySelectorAll(cardsWithStyles),
...
/* harmony default export */ __webpack_exports__["default"] = (showHiddenStyles);

/***/ }),

/***/ "./src/js/modules/showServerCards.js":
/*!*******************************************!*\
  !*** ./src/js/modules/showServerCards.js ***!
  \*******************************************/
/*! exports provided: default */
...
var showServerCards = function showServerCards(trigger, wrapper) {
...
/* harmony default export */ __webpack_exports__["default"] = (showServerCards);
...
var sliders = function sliders(SelectorSlides, sliderDirection, prev, next) {
  var slideIndex = 1,
      paused = false;
  var items = document.querySelectorAll(SelectorSlides);
